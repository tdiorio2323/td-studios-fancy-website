...
import { ProjectCardSkeleton, StatSkeleton } from "@/components/ui/skeleton"
    ...
    <div className="min-h-screen text-white">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/work-portfolio-hero.jpg"
            alt="Creative portfolio showcase with vibrant design work"
            fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              ...
              <div className="glass-card p-8 group cursor-pointer">
                ...
                <p className="text-white/70 font-light leading-relaxed mb-6">
                  Complete digital transformation for a luxury fashion house, featuring custom e-commerce platform,
