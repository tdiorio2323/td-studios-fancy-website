...
export const metadata = generateMetadata({
  ...
  description: "Founded in NYC, TD STUDIOS represents the convergence of luxury design, strategic thinking, and technical excellence. Luxury through restraint. Strategy through precision.",
  path: "/about",
})
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container-custom text-center">
            ...
            <h1 className="chrome-text text-h1 font-bold mb-6 tracking-tight">TD STUDIOS</h1>
        ...
        <section className="py-24 px-6">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="chrome-text text-h2 font-bold mb-6 tracking-tight">Our Story</h2>
            </div>

            <div className="space-y-8 text-body font-light leading-relaxed text-white/80">
              <p>
        ...
        <section className="py-24 px-6 border-t border-white/10">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="chrome-text text-h2 font-bold mb-6 tracking-tight">Our Values</h2>
              <p className="text-body-lg text-white/70 font-light max-w-2xl mx-auto">
        ...
        <section className="py-24 px-6 border-t border-white/10">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="chrome-text text-h2 font-bold mb-6 tracking-tight">Leadership</h2>
        ...
        <section className="py-24 px-6 border-t border-white/10">
          <div className="container-custom text-center">
            <h2 className="chrome-text text-h2 font-bold mb-6 tracking-tight">New York City</h2>
            <p className="text-body-lg text-white/70 font-light mb-8 max-w-2xl mx-auto">
        ...
        <section className="py-24 px-6 border-t border-white/10">
          <div className="container-custom text-center">
            <h2 className="chrome-text text-h2 font-bold mb-6 tracking-tight">Let's Create Together</h2>
            <p className="text-body-lg text-white/70 font-light mb-8 max-w-2xl mx-auto">
